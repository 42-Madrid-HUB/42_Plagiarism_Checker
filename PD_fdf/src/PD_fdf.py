...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/11/07 21:37:34 by ismherna          #+#    #+#              #
#    Updated: 2024/11/07 21:43:03 by ismherna         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
def find_executable_files(directory, pattern='push_swap'):# TODO
...
if __name__ == "__main__":
    ...
    comparison_dir = 'fdf_comparison_repos'
